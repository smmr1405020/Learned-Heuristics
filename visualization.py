...
region_error_mat_euclidean = get_region_error(SE_matrix_landmark, region_dict)
draw_region_heatmap(region_error_mat_euclidean)

'''

get region wise avg sq error heatmap & matrix
get sorted nodewise sq error curve & array
